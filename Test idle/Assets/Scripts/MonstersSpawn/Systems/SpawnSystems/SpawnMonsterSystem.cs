            ...
            foreach (var monsterIndex in _monsterFilter)
            {
                ...
                { 
                    ...
                    foreach (var index in _spawnFilter)
                    {
                        ...
                        ref var spawnSettings = ref _spawnFilter.Get1(index);
                        ref var spawnEntity = ref _spawnFilter.GetEntity(index);
                        
                        Debug.Log("Spawn block timer" + " " + spawnSettings.blockSpawnTimer);
                ...
                entityMonster.Get<RespawnEvent>();
                entityMonster.Del<SpawnMonsterEvent>();
            }
        }
    }
}